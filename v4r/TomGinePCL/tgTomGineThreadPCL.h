...
namespace TomGine
{
  ...
  public:
    ...
    int
    AddPointCloudPCL (const pcl::PointCloud<pcl::PointXYZRGBL> &cloud, float point_size = 1);
    ...
    int
    AddPointCloudPCL (const pcl::PointCloud<pcl::PointXYZRGBNormal> &cloud, float normal_scale = 1.0);
