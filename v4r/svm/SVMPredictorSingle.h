...
public:
  SVMPredictorSingle(const char* filenames);
  ~SVMPredictorSingle();
  
  /** Set scaling of result vector **/
  void setScaling(bool _scale, const char* param_filename);
  
  /** Get a prediction for a vector of relation values. prob returns the probability of the classes. **/
