 ...
 * @param iMu The orientation iMu*PI/8,     //方向（8个方向的Gabor核）
 * @param iNu The scale                     //尺度大小
 * @param dSigma The sigma value of Gabor,  //Gabor的sigma
 */
 ...
 * @param iNu The scale                     //尺度大小
 * @param dSigma The sigma value of Gabor,  //Gabor的sigma
 * @param dF The spatial frequency          //空间频率 dF
 */
