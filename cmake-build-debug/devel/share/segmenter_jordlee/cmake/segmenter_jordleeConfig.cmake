...
if("TRUE" STREQUAL "TRUE")
  ...
  set(segmenter_jordlee_DEVEL_PREFIX /home/fetch/catkin_ws/src/segmenter_jordlee/cmake-build-debug/devel)
...
if(NOT "/home/fetch/catkin_ws/src/segmenter_jordlee/cmake-build-debug/devel/include;/home/fetch/catkin_ws/src/segmenter_jordlee/include;/usr/include/eigen3 " STREQUAL " ")
  set(segmenter_jordlee_INCLUDE_DIRS "")
  set(_include_dirs "/home/fetch/catkin_ws/src/segmenter_jordlee/cmake-build-debug/devel/include;/home/fetch/catkin_ws/src/segmenter_jordlee/include;/usr/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'segmenter_jordlee' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Andreas ten Pas <atp@ccs.neu.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'segmenter_jordlee' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fetch/catkin_ws/src/segmenter_jordlee/${idir}'.  Ask the maintainer 'Andreas ten Pas <atp@ccs.neu.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/fetch/catkin_ws/src/segmenter_jordlee/cmake-build-debug/devel/lib;/opt/ros/indigo/lib)
